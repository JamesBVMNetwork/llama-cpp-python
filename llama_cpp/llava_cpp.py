...
def ctypes_function(name: str, argtypes: list, restype: ctypes.CFUNCTYPE):
    def decorator(func):
...
def clip_add_load_image_size(ctx: clip_ctx_p, load_image_size: ctypes.POINTER(clip_image_size)) -> None:
    """Add load image size to the context."""
    # Variables are not used; suppress unused variable warnings
    del ctx, load_image_size
